import { Viewer, ViewerProvider, useViewer, type ViewerConfig } from "@syyclops/ifc-viewer"
      ...
      >
        ...
        {!hasModels && !isLoading && (
          <div className="empty-state">
            <span className="empty-state-text">Drop an IFC file here or click Upload</span>
        ...
        {isLoading && (
          <div className="progress-overlay">
            <div className="progress-card">
              <span className="progress-text">Loading model... {progress}%</span>
